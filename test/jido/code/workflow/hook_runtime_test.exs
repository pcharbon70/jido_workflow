defmodule Jido.Code.Workflow.HookRuntimeTestAdapter do
...
defmodule Jido.Code.Workflow.HookRuntimeTest do
  ...
  test "runtime subscribes to workflow lifecycle signals and emits hooks" do
    ...
    runtime =
      start_supervised!(
        {HookRuntime,
         name: runtime_name, bus: bus, adapter: Jido.Code.Workflow.HookRuntimeTestAdapter}
      )
