defmodule Jido.Code.Workflow.CompilerTest do
  ...
  test "compile/1 maps built-in skill steps to ExecuteSkillStep" do
    definition =
      base_definition([
        step("run_skill",
          type: "skill",
          module: "Jido.Code.Workflow.TestSkills.CompilerSkill",
          agent: nil,
    ...
    assert %ActionNode{
             ...
             params: %{
               step: %{type: "skill", module: "Jido.Code.Workflow.TestSkills.CompilerSkill"}
             }
