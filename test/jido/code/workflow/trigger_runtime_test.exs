defmodule Jido.Code.Workflow.TriggerRuntimeTestActions.Echo do
  use Jido.Action,
...
defmodule Jido.Code.Workflow.TriggerRuntimeTest do
  ...
  defp write_trigger_workflow(dir, name) do
    ...
    ### echo
    - **type**: action
    - **module**: Jido.Code.Workflow.TriggerRuntimeTestActions.Echo
    - **inputs**:
      - value: `input:value`
