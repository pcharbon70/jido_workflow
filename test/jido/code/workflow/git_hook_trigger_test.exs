defmodule Jido.Code.Workflow.GitHookTriggerTestActions.CaptureGitEvent do
  use Jido.Action,
...
defmodule Jido.Code.Workflow.GitHookTriggerTest do
  ...
  defp write_git_hook_workflow(dir, name) do
    ...
    ### capture_git_event
    - **type**: action
    - **module**: Jido.Code.Workflow.GitHookTriggerTestActions.CaptureGitEvent
    - **inputs**:
