defmodule Jido.Code.Workflow.Actions.ExecuteSubWorkflowStepTestActions.Produce do
  use Jido.Action,
...
defmodule Jido.Code.Workflow.Actions.ExecuteSubWorkflowStepTest do
  ...
  defp write_sub_workflow(dir, name) do
    ...
    ### produce
    - **type**: action
    - **module**: Jido.Code.Workflow.Actions.ExecuteSubWorkflowStepTestActions.Produce
    - **inputs**:
      - value: `input:value`
