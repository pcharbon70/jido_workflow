defmodule Jido.Code.Workflow.Actions.ExecuteAgentStepTestActions.PrepareContext do
  use Jido.Action,
...
defmodule Jido.Code.Workflow.Actions.ExecuteAgentStepTestActions.CodeReviewer do
  use Jido.Action,
    name: "code_reviewer",
    schema: [
...
defmodule Jido.Code.Workflow.Actions.ExecuteAgentStepTestActions.AsyncReviewer do
  use Jido.Action,
    name: "async_reviewer",
    schema: [
      code: [type: :string, required: true]
...
defmodule Jido.Code.Workflow.Actions.ExecuteAgentStepTestActions.SlowReviewer do
  use Jido.Action,
    name: "slow_reviewer",
    schema: []
...
defmodule Jido.Code.Workflow.Actions.ExecuteAgentStepTestActions.FailingReviewer do
  use Jido.Action,
...
defmodule Jido.Code.Workflow.Actions.ExecuteAgentStepTestActions.FormatReviewOutput do
  use Jido.Action,
...
defmodule Jido.Code.Workflow.Actions.ExecuteAgentStepTest do
  use ExUnit.Case, async: true

  alias Jido.Code.Workflow.Actions.ExecuteAgentStep
  alias Jido.Signal
  ...
  test "executes pre-actions, agent, and post-actions for sync mode" do
    step = %{
      "name" => "ai_code_review",
      "agent" => "Jido.Code.Workflow.Actions.ExecuteAgentStepTestActions.CodeReviewer",
      "mode" => "sync",
      "inputs" => %{
      ...
      "pre_actions" => [
        %{
          "module" => "Jido.Code.Workflow.Actions.ExecuteAgentStepTestActions.PrepareContext",
          "inputs" => %{"ast" => "`result:parse_file.ast`"}
        }
      ],
      "post_actions" => [
        %{
          "module" => "Jido.Code.Workflow.Actions.ExecuteAgentStepTestActions.FormatReviewOutput",
  ...
  test "executes agent with async mode" do
    step = %{
      "name" => "security_scan",
      "agent" => "Jido.Code.Workflow.Actions.ExecuteAgentStepTestActions.AsyncReviewer",
      "mode" => "async",
  ...
  test "returns timeout error when async agent exceeds timeout" do
    step = %{
      "name" => "security_scan",
      "agent" => "Jido.Code.Workflow.Actions.ExecuteAgentStepTestActions.SlowReviewer",
      "mode" => "async",
      "timeout_ms" => 10,
      "inputs" => %{}
    }
    ...
    assert_receive {:signal,
                    %Signal{
                      ...
                      data: %{
                        ...
                        "agent" =>
                          "Jido.Code.Workflow.Actions.ExecuteAgentStepTestActions.AsyncReviewer",
                        "mode" => "async",
  ...
  test "suppresses agent state signal when policy excludes agent_state" do
    ...
    step = %{
      "name" => "security_scan",
      "type" => "agent",
      "agent" => "Jido.Code.Workflow.Actions.ExecuteAgentStepTestActions.FailingReviewer",
      "mode" => "sync",
      "inputs" => %{}
    }
