defmodule Jido.Code.Workflow.TestActions.ParseFile do
  use Jido.Action,
    name: "parse_file",
    schema: [
...
defmodule Jido.Code.Workflow.TestActions.BuildSummary do
  use Jido.Action,
    name: "build_summary",
    schema: [
...
defmodule Jido.Code.Workflow.TestActions.FailAction do
  use Jido.Action,
    name: "fail_action",
    schema: []
...
defmodule Jido.Code.Workflow.Actions.ExecuteActionStepTest do
  ...
  test "resolves result references from prior step outputs" do
    step = %{
      "name" => "build_summary",
      "module" => "Jido.Code.Workflow.TestActions.BuildSummary",
  ...
  test "suppresses step failed broadcast when publish policy excludes step_failed" do
    ...
    step = %{
      "name" => "fail_step",
      "type" => "action",
      "module" => "Jido.Code.Workflow.TestActions.FailAction",
      "inputs" => %{}
    }
