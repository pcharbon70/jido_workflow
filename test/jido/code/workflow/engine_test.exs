defmodule Jido.Code.Workflow.EngineTestActions.ParseFile do
  use Jido.Action,
...
defmodule Jido.Code.Workflow.EngineTestActions.BuildSummary do
  use Jido.Action,
...
defmodule Jido.Code.Workflow.EngineTestActions.Fail do
  use Jido.Action,
    name: "engine_fail",
    schema: []
...
defmodule Jido.Code.Workflow.EngineTestActions.Compensate do
  use Jido.Action,
...
defmodule Jido.Code.Workflow.EngineTestActions.Slow do
  use Jido.Action,
    name: "engine_slow",
    schema: []
...
defmodule Jido.Code.Workflow.EngineTestActions.CaptureBackend do
  use Jido.Action,
...
defmodule Jido.Code.Workflow.EngineTest do
  ...
  alias Jido.Code.Workflow.Definition.Settings
  alias Jido.Code.Workflow.Definition.Signals, as: DefinitionSignals
    ...
    definition =
      base_definition([
        %DefinitionStep{
          ...
          type: "action",
          module: "Jido.Code.Workflow.EngineTestActions.CaptureBackend",
    ...
    definition =
      base_definition([
        %DefinitionStep{
          name: "parse_file",
          type: "action",
          module: "Jido.Code.Workflow.EngineTestActions.ParseFile",
        ...
        %DefinitionStep{
          name: "build_summary",
          type: "action",
          module: "Jido.Code.Workflow.EngineTestActions.BuildSummary",
      ...
      base_definition(
        [
          %DefinitionStep{
            name: "slow_step",
            type: "action",
            module: "Jido.Code.Workflow.EngineTestActions.Slow",
            inputs: %{},
            depends_on: []
          }
        ],
    ...
    definition =
      base_definition([
        %DefinitionStep{
          name: "fail_step",
          type: "action",
          module: "Jido.Code.Workflow.EngineTestActions.Fail",
          inputs: %{},
          depends_on: []
        }
      ])
      ...
      base_definition(
        ...
        error_handling: [
          %{
            ...
            "action" => "Jido.Code.Workflow.EngineTestActions.Compensate",
            "inputs" => %{
