defmodule JidoWorkflow.Workflow.FileSystemTriggerTestActions.CapturePath do
  use Jido.Action,
...
defmodule JidoWorkflow.Workflow.FileSystemTriggerTest do
  ...
  defp write_workflow(dir, name) do
    ...
    ### capture_path
    - **type**: action
    - **module**: JidoWorkflow.Workflow.FileSystemTriggerTestActions.CapturePath
    - **inputs**:
