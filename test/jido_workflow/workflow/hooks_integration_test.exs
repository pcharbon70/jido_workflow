defmodule JidoWorkflow.Workflow.HooksIntegrationTestAdapter do
...
defmodule JidoWorkflow.Workflow.HooksIntegrationTest do
  ...
  test "emit_signal_hook/2 maps workflow.run.started to before_workflow" do
    ...
    assert :ok =
             HooksIntegration.emit_signal_hook(
               signal,
               adapter: JidoWorkflow.Workflow.HooksIntegrationTestAdapter
             )
