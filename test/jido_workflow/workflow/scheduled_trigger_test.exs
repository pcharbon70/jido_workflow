defmodule JidoWorkflow.Workflow.ScheduledTriggerTestActions.CaptureTrigger do
  use Jido.Action,
...
defmodule JidoWorkflow.Workflow.ScheduledTriggerTest do
  ...
  defp write_scheduled_workflow(dir, name, schedule) do
    ...
    ### capture_trigger
    - **type**: action
    - **module**: JidoWorkflow.Workflow.ScheduledTriggerTestActions.CaptureTrigger
    - **inputs**:
