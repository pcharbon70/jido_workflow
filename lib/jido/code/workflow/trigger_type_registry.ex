defmodule Jido.Code.Workflow.TriggerTypeRegistry do
  @moduledoc """
  ...
  alias Jido.Code.Workflow.Triggers.FileSystem
  alias Jido.Code.Workflow.Triggers.GitHook
  alias Jido.Code.Workflow.Triggers.Manual
  alias Jido.Code.Workflow.Triggers.Scheduled
  alias Jido.Code.Workflow.Triggers.Signal
