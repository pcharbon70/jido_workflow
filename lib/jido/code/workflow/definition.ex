defmodule Jido.Code.Workflow.Definition.Input do
  @moduledoc """
...
defmodule Jido.Code.Workflow.Definition.Trigger do
  @moduledoc """
...
defmodule Jido.Code.Workflow.Definition.RetryPolicy do
  @moduledoc """
...
defmodule Jido.Code.Workflow.Definition.Settings do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          retry_policy: Jido.Code.Workflow.Definition.RetryPolicy.t() | nil,
          on_failure: String.t() | nil
        }
end

defmodule Jido.Code.Workflow.Definition.Signals do
  @moduledoc """
...
defmodule Jido.Code.Workflow.Definition.Step do
  @moduledoc """
...
defmodule Jido.Code.Workflow.Definition.Return do
  @moduledoc """
...
defmodule Jido.Code.Workflow.Definition do
  @moduledoc """
