defmodule JidoWorkflow.Workflow.Registry.Entry do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          enabled: boolean(),
          definition: JidoWorkflow.Workflow.Definition.t() | nil,
          compiled: term() | nil,
          errors: [term()],
...
defmodule JidoWorkflow.Workflow.Registry do
  @moduledoc """
  ...
  @type compile_fun :: (JidoWorkflow.Workflow.Definition.t() -> {:ok, term()} | {:error, term()})
  ...
  @spec get_definition(String.t(), GenServer.server()) ::
          {:ok, JidoWorkflow.Workflow.Definition.t()} | {:error, :not_found | :invalid}
