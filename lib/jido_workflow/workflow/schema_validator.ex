defmodule JidoWorkflow.Workflow.SchemaValidator do
  @moduledoc """
  Validates workflow and trigger configuration maps against JSON schemas.

  Errors are normalized into `JidoWorkflow.Workflow.ValidationError` values.
  """

  alias JidoWorkflow.Workflow.Schema
